          ...
          <div className="max-w-7xl mx-auto flex flex-col gap-10">
            {loading ? (
              ...
              <>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-md border border-green-100 overflow-hidden relative">
                  ...
                  <div className="relative z-10">
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-4 mb-6">
                      ...
                      <div className="text-center md:text-left">
                        <h1 className="text-3xl md:text-5xl font-black text-emerald-900 leading-tight">
                          Share Your Story & <br />
                    ...
                    <p className="text-lg md:text-xl text-emerald-800 font-semibold mb-10 max-w-3xl text-center md:text-left">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center relative">
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                          <div className="flex gap-4">
                            <div className="bg-emerald-900 text-white w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0 text-lg shadow-sm">
                              1
                            </div>
                            <div>
                      ...
                      <div className="flex flex-col items-center md:items-start text-center md:text-left relative py-8 px-4">
                        ...
                        <div className="flex items-center gap-2 mb-6 ml-0 md:ml-8">
                          <FiDollarSign className="text-green-600 text-3xl font-bold" />
                          <h3 className="text-2xl font-extrabold text-emerald-900 uppercase tracking-tighter">
                            Winning Potential
                          </h3>
                        </div>

                        <div className="relative ml-0 md:ml-8">
                          <div className="text-[120px] md:text-[180px] font-black text-green-500 leading-none opacity-40">
                            20
                          </div>
                          <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <span className="text-emerald-800 text-lg uppercase font-medium">
                        ...
                        <div className="mt-2 ml-0 md:ml-8">
                          <p className="text-4xl md:text-7xl font-black text-green-600 tracking-tight">
                            $2 to $100!
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="mt-12 bg-green-50 py-4 px-8 rounded-xl border border-green-100 text-center md:text-left shadow-inner">
                      <p className="text-emerald-900 text-lg md:text-xl font-semibold">
                        <span className="bg-green-600 text-white px-3 py-1 rounded-lg text-sm font-bold mr-3">
                          Pro-Tip:
                        </span>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-6 text-center md:text-left relative overflow-hidden">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div
                        key={plat.id}
                        className="flex flex-col sm:flex-row items-center gap-4 bg-gray-50 p-4 rounded-2xl border border-gray-100 hover:border-green-200 transition-all"
                      >
                        <div className="flex items-center gap-4 w-full sm:w-40">
                          <div
                            className={`${plat.color} w-12 h-12 rounded-xl flex items-center justify-center text-white shadow-sm flex-shrink-0`}
                          >
                            {plat.icon}
                          </div>
                        ...
                        <div className="flex flex-grow gap-2 w-full">
                          ...
                          <button
                            ...
                            className="bg-green-500 text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-green-600 transition-all active:scale-95 disabled:opacity-50 whitespace-nowrap shadow-sm shadow-green-100"
                          >
